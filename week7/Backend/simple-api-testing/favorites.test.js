...
describe('Favorites API', function () {
  describe('POST /favorites', function () {
    describe('when creating a favorite airport', function () {
      ...
      it('should allows a user to get their favorite airports', async function () {
      ...
      it('should allows a user to save and delete their favorite airports', async function () {
        // Check that a user can create a favorite.
        const postResponse = await request
          .post('/favorites')
          .set('Authorization', 'Bearer token=NTyqLpqBW2dqg1Fq7ud17n1x')
